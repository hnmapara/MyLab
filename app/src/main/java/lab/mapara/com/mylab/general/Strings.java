...
//        System.out.println("Minimum substring = " + minWindowHavingAllCharacter("ADOBECODEBANC", "RAD"));
        System.out.println("starting index = " + Arrays.toString(findStartIndexOfAllAnagramsOfTargetString("bbbbbacccc", "abc")));
    }
...
*/
    ...
    //Working
    public static int[] findStartIndexOfAllAnagramsOfTargetString(String s, String p) {
